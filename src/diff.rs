    ...
    pub fn apply_patch(base_content: &str, delta: &ArtifactDiff) -> String {
        ...
        while i < diff_lines.len() {
            ...
            if line.starts_with("@@") {
                ...
                let old_len = if old_info.len() > 1 { old_info[1].parse::<usize>().unwrap_or(0) } else { 1 };
                ...
                result_lines.splice(apply_pos..apply_pos + actual_old_len, new_hunk_content.clone());
...
mod tests {
    ...
    #[test]
    fn test_unicode_patching() {
        let old = "🦀 is a crab\n";
        let new = "🦀 is a Rust crab\n";
